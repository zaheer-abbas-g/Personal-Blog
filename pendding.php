<?php 
    ...
    include_once("sessionMentainance.php");
          ...
          if (isset($_GET['pending'])) {
           $user_id=$_GET['pending'];    
           $update="UPDATE user SET is_approved='Pending'  WHERE user_id=$user_id";
           $result=mysqli_query($connect,$update);  
           if ($result) {
                $message="<p style='color:red'>account is pending</p>";
            }  
        }
?>
...
<body style="background-color:#717482">
 ...
 <div class="row">
    ...
    <div style="width:97%;margin-top: -50%;margin-bottom: 5%;margin-left: 14%">
        <div class="col-sm-12 text-black" style="background-color: lightgray;border-radius: 10px;width: 50%;margin-left: 2%;margin-bottom: 5%"> <h1>Account Pending </h1>
        </div>    
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                             ?>
                              <tr align="center">
                                ...
                                <td>
                                <a href="pendding.php?pending=<?php echo $row['user_id'] ?>">
                                <i class='fas fa-question-circle' style='font-size:20px;color:blue'>    
